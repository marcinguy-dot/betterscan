/* Lattice jQuery frontend - shared helpers.
 *
...
(function (window) {
  ...
  // API base URL. Override by setting window.LATTICE_API before this script
  // loads (see config.js) or via a <meta name="lattice-api"> tag.
  var API_BASE =
    window.LATTICE_API ||
    (function () {
      var meta = document.querySelector('meta[name="lattice-api"]');
      return (meta && meta.getAttribute("content")) || "http://localhost:8080";
    })();

  var TOKEN_KEY = "lattice_token";
  var USER_KEY = "lattice_user";
  ...
  function renderNav(activePage) {
    ...
    var html =
      ...
      '    <a class="navbar-brand fw-bold" href="index.html">Lattice</a>' +
