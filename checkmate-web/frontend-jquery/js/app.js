/* Checkmate jQuery frontend - shared helpers.
 *
...
(function (window) {
  ...
  // API base URL. Override by setting window.CHECKMATE_API before this script
  // loads (see config.js) or via a <meta name="checkmate-api"> tag.
  var API_BASE =
    window.CHECKMATE_API ||
    (function () {
      var meta = document.querySelector('meta[name="checkmate-api"]');
      return (meta && meta.getAttribute("content")) || "http://localhost:8080";
    })();

  var TOKEN_KEY = "checkmate_token";
  var USER_KEY = "checkmate_user";
  ...
  function renderNav(activePage) {
    ...
    var html =
      ...
      '    <a class="navbar-brand fw-bold" href="index.html">Checkmate</a>' +
